...
export const EquipmentDetailsList: React.FC = () => {
    ...
    const load = () => {
        ...
        if (stored.length > 0) {
            ...
            setData(getMockEquipmentDetails() as unknown as EquipmentRecord[])
        }
    }
    ...
    const handleFormSubmit = () => {
        ...
        if (editing) {
            localStorageService.updateEquipment(editing.id, {
                ...
                source_of_fund: form.source_of_fund || '0',
                status: form.status || '',
            })
        } else {
        ...
        <>
            ...
            {isKvkUser && (
                <Modal
                    ...
                    title={editing ? 'Edit Equipment Details' : 'Add Equipment Details'}
                    size="lg"
                >
                    <div className="space-y-4">
                        ...
                        <Input
                            ...
                            value={String(form.source_of_fund ?? '0')}
                            onChange={e => handleFormChange('source_of_fund', e.target.value)}
                        />
                        <Input
